...
CUSTOM_HAL_IMGSENSOR=ov13855_mipi_raw s5k3p3sx_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR=ov13855_mipi_raw s5k3p3sx_mipi_raw
...
CUSTOM_MODEM=BBK6763_66_N1_LWCTG_BBKMake_PD1718_n
...
MTK_BRANCH = alps-mp-n1.mp16.tc19sp
...
MTK_BUILD_VERNO = alps-mp-n1.mp16.tc19sp-V1_bbk6763.66.n1_P51
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE=2
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_kernel_4-4 rel_customer_modem rel_customer_platform_mt6763
...
MTK_ANDROID_VERSION = ANDROID_N
MTK_REBOOT_META_SUPPORT = yes
MTK_META_RSSITRIGGER_SUPPORT = yes
MTK_ATM_METAWIFIONLY = yes
CUSTOM_LK_LCM=pd1718_ft8006m_720plus_dsi_vdo_boe_3lane pd1718_ft8006m_720plus_dsi_vdo_tm_3lane
VIVO_EYECARE_SUPPORT=1
BBK_LM3697_3_STRING=yes
MTK_ROUND_CORNER_SUPPORT=yes
BBK_BLULIGHT_MAPPING_PD1718=yes
BBK_DRIVER_ONLY_ON=no
BBK_VIVO_SOURCE_FILTER_OUT=no
BBK_SCM_PORTING=no
BBK_SPLIT_FRAMEWORK=no
BBK_VIVO_ROM=rom_3.6
BBK_VIVO_ROM_VERSION=rom_3.6
BBK_VIVO_ROM_STYLE=vigour
BBK_VIVO_OS_NAME=Funtouch
BBK_VIVO_OS_VERSION=OS_3.2
BBK_VIVO_OS_REQ_VERSION=3.2
BBK_PRODUCT_SOLUTION=MTK
BBK_TARGET_PRODUCT=full_bbk6763_66_n1
BBK_PRODUCT_SOLUTION_MTK=yes
BBK_PRODUCT_PLATFORM=MTK6763
BBK_PRODUCT_OVERLAY=mt6763
BBK_PRODUCT_BRAND=vivo
BBK_PRODUCT_MODEL=PD1718
BBK_PRODUCT_RELEASE_BRAND=vivo
BBK_PRODUCT_RELEASE_NAME=PD1718
BBK_PRODUCT_VERSION=PD1718_A_1.10.6
BBK_PRODUCT_HARDWARE_VERSION=PD1718MA
BBK_HARDWARE_VERSION=PD1718MA
BBK_BOARD_VERSION=MA
BBK_PRODUCT_LOCALES=zh_CN en_US zh_HK zh_TW ug_CN bo_CN tl_PH in_ID my_ZG vi_VN ja_JP ko_KR ru_RU ar_EG km_KH lo_LA ms_MY th_TH hi_IN hdpi xhdpi
BBK_OTA_ARGS=-n
...
BBK_TARGET_RELEASETOOLS_EXTENSIONS=vendor/vivo/build/releasetools/mtk/mt6763_7.1
BBK_SPEC_CUSTOM_APP=ifly_ivw30 awox_dlna fingerprint baidu_location
...
BBK_OEM_PROJECTS=PD1718_CN-YD PD1718_CN-YD-A PD1718_CN-YD-B PD1718_CTCC_RWA PD1718_CTCC_SC PD1718_GMS PD1718_FULL_SC PD1718_FULL_UNICOM_RWA PD1718_CMCC_RWB PD1718_CTCC_RWC
BBK_OEM_PROJECT_LIST=PD1718
BBK_OEM_SUPPORT=yes
BBK_OEM_PROJECT_DEFAULT=PD1718_FULL_SC
BBK_FOR_UNINSTALL=yes
MTK_WIFIWPSP2P_NFC_SUPPORT=no
MTK_BEAM_PLUS_SUPPORT=no
MTK_NFC_APP_SUPPORT=no
MOBICONVERT_REMOTE=yes
BBK_PROPERTIYS_PERSIST=qemu.hw.mainkeys.vivo=0 persist.vivo.doubleinstance=multi_user persist.vivo.phone.usb_otg=Have_usb_otg persist.vivo.phone.key_light=No_key_light persist.vivo.phone.indicator=Have_indicator_green persist.vivo.phone.sarpower=Have_sarpower persist.vivo.double_debug=enable persist.vivo.phone.screen_size=50 persist.vivo.smartkey.enable=true persist.vivo.fingerprint.front=false persist.vivo.support.fingerkey=false persist.vivo.phone.num_battery=Have_battery_percentage persist.vivo.facedetect.support=1 persist.facedetect.debug.level=0 persist.facedetect.skip.guard=1 persist.radio.vivo.volte=3 persist.radio.vivo.volte.sim2=3 persist.radio.volte.deafult=1 persist.vivo.phone.wfd=Have_wfd ro.vivo.media.subtitle_support=true persist.vivo.multiwindow=true ro.com.baidu.baidumap=data/yzfswj/another/ persist.use.backcamera=1 persist.vivo.game_no_disturb=1 persist.vivo.compass.no_return=true persist.vivo.freeform=true persist.vivo.default_sougou_ime=1
BBK_PROPERTIYS_PERSIST_DEBUG=persist.sys.ssr_ramdump=1
BBK_PROPERTIYS_RO=
BBK_PROPERTIYS_RO_DEBUG=
BBK_PROPERTIYS_OVERRIDES=ro.config.notification_sound=Whistle.ogg ro.config.alarm_alert=Morning_scene.ogg ro.config.message_sound=Default.ogg ro.config.ringtone=Sunrise_View.ogg ro.kernel.android.checkjni=0 ro.com.android.dataroaming=false ro.config.hifi_config_state=0 persist.vivo.karaoke.enable=true
BBK_CCM_POWER_STR=yes
MTK_CT4GREG_APP=no
...
BBK_FEATURE_BBESONICMAX=no
BBK_FEATURE_DUAL_MIC_INVERSE=no
BBK_FEATURE_VAFX_MTK=yes
BBK_FEATURE_VAFX_HP_AP=yes
VIVO_CHARGING_NEW_ARCH=yes
VIVO_BQ24296_NORMAL_CHARGING=yes
MTK_IPOH_SUPPORT=no
CUST_FEATURE_ALSPS_PARAMETER_FOR_PD1718=yes
WIFI_PARAMETER_PD1718=yes
BBK_FEATURE_TFA98XX=tfa9891
VIGOUR_FEATURE_CONTROL=0x00000005
BBK_SUPPORT_TF=yes
